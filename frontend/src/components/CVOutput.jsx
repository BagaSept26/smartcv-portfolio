// frontend/src/components/CVOutput.jsx
  ...
  return (
    <div className="mt-10 p-6 bg-slate-700/70 rounded-lg shadow-xl">
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          onClick={handleCopy}
          className="py-2 px-4 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-md shadow-sm transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-700 focus:ring-emerald-500"
        >
          Salin Teks
        </button>
      </div>
      ...
      <p className="mt-4 text-xs text-slate-400">
        Periksa kembali ringkasan ini dan sesuaikan jika perlu sebelum digunakan.
      </p>
    </div>
  );
}
